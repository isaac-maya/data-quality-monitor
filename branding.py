...
Drop this file into any demo repo and call apply_branding() at the top of app.py.
Provides:
  - apply_branding()          → injects fonts + CSS, must be called once
  - hero(title, kicker, badges)  → big branded hero block
  - section(title, color)     → colored section divider
...
def section(title: str) -> None:
    """Render a section divider with an accent bar."""
    st.markdown(
...
def footer(repo_slug: str) -> None:
    """Standard contact footer. repo_slug is e.g. 'data-quality-monitor'."""
    st.markdown(
        f"""
<div class="im-footer">
  ...
  <div class="im-links">
    ...
    <a href="https://github.com/isaac-maya/{repo_slug}" target="_blank">🔗 Source</a>
